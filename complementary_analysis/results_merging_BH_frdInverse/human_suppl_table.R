...
bh_file_0.001 <- "./complementary_analysis/results_merging_BH_frdInverse/Human/Calls_merging_BH_cutoff=0.001_species_id=9606.tsv"
...
bh_file_0.0001 <- "./complementary_analysis/results_merging_BH_frdInverse/Human/Calls_merging_fdr_inverse_cutoff=1e-04_species_id=9606.tsv"
fdr_inverse_file_0.0001 <- "./complementary_analysis/results_merging_BH_frdInverse/Human/Calls_merging_fdr_inverse_cutoff=1e-04_species_id=9606.tsv"
...
collectStats_merging <- function(outputFolder, bh, fdr_inverse, cutoff){
  ...
  capture.output(collectAllStats, file = file.path(outputFolder,paste0("Statistics_Human_Lung_",cutoff,"_threshold_for_RefInt_methods.tsv")))
