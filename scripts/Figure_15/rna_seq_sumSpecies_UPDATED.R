...
rna_seq_sample_info <- "./data/Data_generated_By_Bgee/rna_seq_sample_info.txt"
kallisto_count_folder <- "./data/Different_alignments_PIKE/pike_folder_samples_Quants_Hisat2/"
sum_by_species_folder <- "./data/Different_alignments_PIKE/pike_folder_samples_Quants_Hisat2/"

## keep just pike 
sampleInfo <- dplyr::filter(rnaSeqLib, speciesId == 8010)
